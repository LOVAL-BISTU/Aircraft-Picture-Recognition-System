...
%      Version: $Id: filtbankm.m,v 1.4 2011/03/24 19:45:28 dmb Exp $
%
...
%
cf=max(mflh(1)+(0:p+1)*melinc,0); % centre frequencies in mel/erb/... including ends
switch wr    % convert centre frequencies from mel/erb/... to FFT bins0
    case 'l'
        mb=10.^(cf)*n/fs;
    case 'e'
        mb=erb2frq(cf)*n/fs;
